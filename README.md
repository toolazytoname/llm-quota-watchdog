...
| Sorting | **expiry first while unfinished** (default, based on each card's longest quota window) / waste speed / by usage / custom order; automatic sorts keep each provider together |
